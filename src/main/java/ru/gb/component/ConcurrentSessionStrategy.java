...
import ru.gb.service.SessionManager;
...
public class ConcurrentSessionStrategy extends ConcurrentSessionControlAuthenticationStrategy {
    ...
    private final SessionManager sessionsManager;

    public ConcurrentSessionStrategy(SessionRegistry sessionRegistry, SessionManager sessionsManager) {
